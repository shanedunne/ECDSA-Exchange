...
function mnemonicToSeed(mnemonic, passphrase = '') {
    assertMnemonic(mnemonic);
    return (0, pbkdf2_1.pbkdf2Async)(sha512_1.sha512, nfkd(mnemonic), salt(passphrase), { c: 2048, dkLen: 64 });
}
exports.mnemonicToSeed = mnemonicToSeed;
function mnemonicToSeedSync(mnemonic, passphrase = '') {
    assertMnemonic(mnemonic);
    return (0, pbkdf2_1.pbkdf2)(sha512_1.sha512, nfkd(mnemonic), salt(passphrase), { c: 2048, dkLen: 64 });
}
